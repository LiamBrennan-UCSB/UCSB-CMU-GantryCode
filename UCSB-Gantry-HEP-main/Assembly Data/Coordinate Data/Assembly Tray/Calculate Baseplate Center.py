...
def map_to_gantry(gantry,OGP):
   ...
   # print("This is XY_diff(1)", XY_diff)
    #print("This is Gantry[0][0]:", gantry[0][0])
    #print("This is Gantry[0][1]:", gantry[0][1])
    U_diff = get_angle(gantry[0],gantry[1]) - get_angle(OGP[0],OGP[1])    ### rotational constant
    #print("This is get_angle(gantry)", get_angle(gantry[0],gantry[1]))
    print("This is U_diff normal", U_diff)
    mapped_OGP = []
 ...
 #       print("This is XY[0]", XY[0], "this is XY[1]", XY[1])
      #  print("This is Gantry[0][0]",gantry[0][0], "This is Gantry[0][1]", gantry[0][1])
        ...
        #tXY uses the top fiducial
  #      print("This is XY[1]", XY[1])
  #      print("This is XY_diff[1]", XY_diff[1])
        print("This is tXY", tXY)
        #print("This is XY:", XY[0])
        theta_prime = atan2(tXY[1],tXY[0]) + U_diff       ### get angle of XY and add theta difference between F1 meas and rel
        #print("This is tXY[1]", tXY[1])
        #print("This is tXY[0]", tXY[0])
        #print("This is theta_prime:", theta_prime)
...
def map_to_gantry_Right_Partial(gantry,OGP):
    XY_diff = [gantry [0][0] - OGP[0][0],gantry[0][1] - OGP[0][1]]    ### XY translational constant
    #print("This is XY diff", XY_diff)
    print("This is Gantry[0][0]", gantry[0][1])
    print("this is OGP[0[0]]", OGP[0][1])
    U_diff = get_angle(gantry[0],gantry[1]) - get_angle(OGP[0],OGP[1])    ### rotational constant
    #print("This is get_angle(gantry)", get_angle(gantry[0],gantry[1]))
    #print("This is get_angle(OGP)", get_angle(OGP[0],OGP[1]))
  #  print("this is U diff Right Partial: ", U_diff)
    mapped_OGP = []
    for XY in OGP:      ### OGP fiducials do not need to returned
        tXY = [XY[0] - gantry[0][0] + XY_diff[0], XY[1] - gantry[0][1] + XY_diff[1]]  ### subtract F1 and add translational XY
        #print("this is tXY", tXY)
...
print("This is Right Partial Calculate Center:", Calculate_Centers_Right_Partial(gantryRightPartial,OGPPartialRight))
